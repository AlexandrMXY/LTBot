                ...
                (message) -> {
                    ...
                    if (args.length == 2) {
                        if ("list".equals(args[1])) {
                            scrapperService
                                    .getTagsList(message.chatId())
                                    .subscribe(
                                            (tags) -> sessionStateManager.onUpdate(
                                                    message.chatId(),
                        ...
                        if ("mute".equals(args[1])) {
                            scrapperService
                                    .deactivateTag(message.chatId(), args[2])
                                    .subscribe(
                            ...
                            scrapperService
                                    .reactivateTag(message.chatId(), args[2])
                                    .subscribe(
                                            (success) -> sessionStateManager.onUpdate(
                                                    message.chatId(), new SuccessResponseEvent("Success")),
                                            (t) -> sessionStateManager.onUpdate(
                            ...
                            scrapperService
                                    .getLinksWithTag(message.chatId(), args[2])
                                    .subscribe(
                                            links -> sessionStateManager.onUpdate(
                                                    message.chatId(),
                                                    new SuccessResponseEvent(formatter.format(links))),
                                            t -> sessionStateManager.onUpdate(
                                                    message.chatId(), new ErrorResponseEvent(t)));
                            return true;
                        }
                        ...
                        if ("add".equals(args[1])) {
                            scrapperService
                                    .addTagToLink(message.chatId(), args[2], args[3])
                                    .subscribe(
                                            (success) -> sessionStateManager.onUpdate(
                                                    message.chatId(), new SuccessResponseEvent("Success")),
                                            (t) -> sessionStateManager.onUpdate(
                            ...
                            scrapperService
                                    .removeTagFromLink(message.chatId(), args[2], args[3])
                                    .subscribe(
                                            (success) -> sessionStateManager.onUpdate(
                                                    message.chatId(), new SuccessResponseEvent("Success")),
                                            (t) -> sessionStateManager.onUpdate(
